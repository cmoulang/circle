...
EXTERN_C void WriteDataPort(unsigned char data);
EXTERN_C unsigned char ReadJoystick();

extern unsigned char portbDir;

#define LatchAddressIn() { LatchedAddressLast=ReadAddress(); }
#define WASWRITE ReadIBF()
#define ReadDataPort() { LatchedData=ReadPort(); }
